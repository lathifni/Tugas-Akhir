...
export default function DeleteUnitFacilityDialog({ isOpen, setIsOpen, rowDelete, onSuccessfulDelete }: Props) {

  const handleDelete = () => {
    // useAxiosAuth.delete(`/homestay/${rowDelete.id}`)
    // .then((res) => {
    //   setIsOpen(!isOpen)
  ...
  return (
    <Dialog open={isOpen}>
      <div className="px-10 py-2">
        ...
        <p>
          Are you sure to delete facility unit homestay <strong>{rowDelete.name}</strong> ?
        </p>
      </div>
