...
export default function DeleteUnitDialog({ isOpen, setIsOpen, rowDelete, onSuccessfulDelete }: Props) {
  ...
  return (
    <Dialog open={isOpen}>
      <div className="px-10 py-2">
        ...
        <p>
          Are you sure to delete Unit Homestay <strong>{rowDelete.name}</strong> ?
        </p>
      </div>
