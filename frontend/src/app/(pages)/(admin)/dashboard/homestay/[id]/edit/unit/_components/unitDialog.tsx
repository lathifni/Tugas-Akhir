...
const unitSchema = z.object({
  unit_name: z.string().min(1, 'Package name cannot be empty'),
...
export default function UnitDialog({ isOpen, setIsOpen, onSave, id, }: Props) {
  ...
  return (
    <Dialog open={isOpen} maxWidth="lg" sx={{ "& .MuiDialog-paper": { width: "50%", maxWidth: "none" } }}>
      <h3 className="text-center ">Add Unit Homestay</h3>
