...
export default function DeleteDialogFacility({ isOpen, setIsOpen, rowDelete, setNotification, onSuccessfulDelete }: Props) {

  const handleDelete = () => {
    useAxiosAuth.delete(`/facility/${rowDelete.id}`)
    .then((res) => {
      setIsOpen(!isOpen)
