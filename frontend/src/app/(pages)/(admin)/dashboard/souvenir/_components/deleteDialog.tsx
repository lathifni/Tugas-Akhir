...
export default function DeleteDialogSouvenir({ isOpen, setIsOpen, rowDelete, setNotification, onSuccessfulDelete }: Props) {

  const handleDelete = () => {
    useAxiosAuth.delete(`/souvenir/${rowDelete.id}`)
    .then((res) => {
      setIsOpen(!isOpen)
