...
export default function DeleteDialogPackage({ isOpen, setIsOpen, rowDelete, setNotification, onSuccessfulDelete }: Props) {

  const handleDelete = () => {
    console.log('handleDelete');
    
    useAxiosAuth.delete(`/package/${rowDelete.id}`)
    .then((res) => {
      setIsOpen(!isOpen)
