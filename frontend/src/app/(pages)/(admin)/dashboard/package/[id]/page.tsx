...
import { faCaretDown, faCartPlus, faCirclePlay, faPen, faPenClip, faRoad, faSquarePlus } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="w-full h-full px-1 xl:p-0 xl:mb-0 xl:mr-3 xl:w-7/12 ">
          <div className="relative py-5 bg-white rounded-lg mb-5 px-5 shadow-lg">
            ...
            <div className="justify-center items-center">
              <Link href={`/dashboard/package/${dataPackageActivityById[0]?.package_id}/edit`}>
