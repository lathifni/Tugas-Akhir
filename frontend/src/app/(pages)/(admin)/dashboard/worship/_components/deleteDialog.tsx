...
export default function DeleteDialogWorship({ isOpen, setIsOpen, rowDelete, setNotification, onSuccessfulDelete }: Props) {

  const handleDelete = () => {
    useAxiosAuth.delete(`/worship/${rowDelete.id}`)
    .then((res) => {
      setIsOpen(!isOpen)
