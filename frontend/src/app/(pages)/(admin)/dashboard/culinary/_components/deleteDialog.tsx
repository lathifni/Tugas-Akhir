...
export default function DeleteDialogCulinary({ isOpen, setIsOpen, rowDelete, setNotification, onSuccessfulDelete }: Props) {

  const handleDelete = () => {
    useAxiosAuth.delete(`/culinary/${rowDelete.id}`)
    .then((res) => {
      setIsOpen(!isOpen)
