...
import { fetchGeomEstuary, fetchListGeomWater } from "@/app/(pages)/api/fetchers/attraction";
...
export default function Water() {
  ...
  const { data: data, isLoading: loadingListaGeomHomestay } = useQuery({
      ...
      <div className="flex flex-col lg:flex-row m-1 sm:m-3 lg:m-5">
        <div className="w-full h-full px-1 py-1 mb-3 lg:p-0 lg:mb-0 lg:mr-3 sm:py-3 lg:w-2/3 bg-white rounded-lg">
          ...
          <div className="pb-5 md:mx-3">
            ...
            userLocation={userLocation} selectedId={selectedWaterId} type={'water'}/>
          </div>
        </div>
