...
export default function RefundConfirmationDialog({ isOpen, setIsOpen, onSave, gallery, }: Props) {
 ...
 const handleSave = () => {
  ...
  return (
    <Dialog open={isOpen} maxWidth="lg" sx={{ "& .MuiDialog-paper": { width: "50%", maxWidth: "none" } }}>
      <h3 className="text-center mx-4">Refund Confirmation</h3>
      <DialogContent dividers>
        <div className="">
          <label className="block mt-2 text-sm font-medium text-gray-900">Confirmation Refund (Is the proof of refund correct?)</label>
          <RadioGroup
            row
            name="confirmation"
