...
export default function MapHome({ userLocation, dataMapforType, radius, isManualLocation, 
  setUserLocation,dayActivities, selectActivities, objectAround,
  setIsManualLocation, goToObject, setGoToObject, showLegend, visibility, reachToObject
  ...
  useEffect(() => {
    const fetchObjectAroundRadius = async () => {      
      if (userLocation && map && locationMarkerRef.current && radius !== null) {
        console.log('di dalam if nya nih');
