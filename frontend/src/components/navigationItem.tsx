...
export default function NavigationItem() {
  ...
  return (
    <div>
      <div className={` bg-teal-800 relative duration-500 select-none`} >
        <ul className="pt-6 px-3 font-medium text-base">
          ...
          <ul>
            <li className="flex rounded-md mx-8 cursor-pointer hover:bg-teal-400 text-white items-center gap-x-4">
